  ...
  return (
    <section className="w-full flex justify-center mx-auto py-open-4xl tablet:py-open-5xl desktop:py-open-5xl -bg--openfoundation-black max-w-[1320px]">
      <div className="w-full flex flex-col items-center tablet:items-stretch desktop:items-stretch  gap-open-xl tablet:gap-open-3xl desktop:gap-open-3xl ">
        <h3 className="block -text--openfoundation-white font-open-heading text-open-font-xxl tablet:text-open-font-xxxl desktop:text-open-font-xxxl">
          OPEN Your Future
          <br />
          with&nbsp;
          <span
        ...
        <small className=" -text--openfoundation-white  font-open-paragraph text-open-font-small tablet:text-open-font-large desktop:text-open-font-large">
